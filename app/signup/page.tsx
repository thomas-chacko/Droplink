...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const data = await authServices.signup({ username, email, password });
          ...
          <div className="w-full max-w-md">
            ...
            <div>
              ...
              <button
                ...
                className="w-full py-3 bg-white text-gray-900 font-semibold rounded-xl hover:bg-gray-100 transition shadow-lg hover:shadow-xl flex items-center justify-center gap-3 mb-6"
              >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 bg-white/10 border ${validationErrors.username ? 'border-red-500' : 'border-white/20'
                        } rounded-xl focus:ring-2 focus:ring-yellow-400 focus:border-transparent outline-none transition text-white placeholder-blue-300`}
                      placeholder="johndoe"
                      required
                      disabled={isLoading}
                    />
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 bg-white/10 border ${validationErrors.email ? 'border-red-500' : 'border-white/20'
                        } rounded-xl focus:ring-2 focus:ring-yellow-400 focus:border-transparent outline-none transition text-white placeholder-blue-300`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 bg-white/10 border ${validationErrors.password ? 'border-red-500' : 'border-white/20'
                        } rounded-xl focus:ring-2 focus:ring-yellow-400 focus:border-transparent outline-none transition text-white placeholder-blue-300`}
                      placeholder="••••••••"
                      required
                      disabled={isLoading}
                  ...
                  {!validationErrors.password && password.length > 0 && password.length >= 6 && (
                    <p className="mt-1 text-sm text-green-300 flex items-center gap-1">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3 bg-yellow-400 text-gray-900 font-bold rounded-xl hover:bg-yellow-300 transition shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isLoading ? (
                    <>
